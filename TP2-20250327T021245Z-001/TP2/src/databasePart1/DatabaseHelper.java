...
//			 statement.execute("DROP ALL OBJECTS");
	...
	public boolean addAnswer(Answer a) {
        String sql = "INSERT INTO answers (id, questionId, answerText, author, accepted) VALUES (?, ?, ?, ?, ?)";
        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            ...
            pstmt.setBoolean(5, a.isAccepted());
	...
	public boolean acceptAnswer(int answerID) {
		String query = "UPDATE answeres SET accepted = ? WHERE id = ?";
