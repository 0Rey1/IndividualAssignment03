...
public class DisplayUsersPage {
	...
	public DisplayUsersPage(DatabaseHelper databaseHelper, User user) {
    ...
    public void show(Stage primaryStage) {
	    ...
	    backButton.setOnAction(e -> new AdminHomePage(user, databaseHelper).show(primaryStage));

	    VBox layout = new VBox();
	    
	    if (users.isEmpty())
	    {
	    	layout = new VBox(emptyLabel, backButton);
	    }
	    else
	    {
	    	layout = new VBox(tableView, refreshButton, backButton);
	    }
